...
$red = "\e[91m";
echo "$red  ##############################################\n";
echo "$red  #                Creator:Mr.Rush             #\n";
echo "$red  #             Profil Guard Via Termux*_*     #\n";
echo "$red  #      spesial Thanks:Mr.L3RB1,all my friend #\n";
echo "$red  ##############################################¿½\n\n";
echo "$input $green Silahkan Masukin Tokennya Akunmu>> : ";
...
if($me && $me->id) {
    ...
    if($hajar->data->is_shielded_set->is_shielded) echo "$green Status ==> $green Selamat kamu berhasil memasang facebook Guard*_*";
    else "Failed! silahkan check token mu kembali! ";
}
?>
